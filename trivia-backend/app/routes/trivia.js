 ...
 *     curl -i https://api.jakedecrane.com/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.jakedecrane.com/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.jakedecrane.com/api/trivia/question/1
 */
